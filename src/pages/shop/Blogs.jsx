        ...
        <>
            <div className="h-[250px] lg:h-[700px] flex gap-2 lg:gap-10" style={({backgroundImage: `url(${bgImage})`, backgroundPosition: "center", backgroundSize: "cover"})}>
                <div className="w-[58%] lg:w-[50%] pl-5 lg:pl-16 py-10 lg:py-20 flex flex-col">
                    ...
                    <button className="self-center mt-6 lg:mt-16 rounded-full px-3 lg:px-20 py-1 lg:py-3 text-white bg-gradient-to-r from-[rgb(248,181,44)] to-[rgb(240,85,120)] text-xs lg:text-2xl font-medium lg:font-semibold mr-5">Explore Now !</button>
                </div>

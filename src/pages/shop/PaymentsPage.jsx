                        ...
                        <div className="w-full flex flex-col lg:flex-row gap-8">
                            <div className="w-full lg:w-[60%] space-y-4">
                                <div className="border border-[rgb(8,43,61)] rounded-xl px-4 py-3 relative">
                                    <p className='xl:text-sm 2xl:text-base font-semibold'><i class="fi fi-rr-badge-percent relative top-[2px] mr-1"></i>DISCOUNTS & OFFERS</p>
                                    ...
                                    <span onClick={(e) => { e.preventDefault(), setShowMore(!showMore) }} className='xl:text-xs 2xl:text-sm cursor-pointer font-medium '>{showMore ? "View Less" : "View More"} {showMore ? <i class="fi fi-br-angle-small-up relative top-[2px]"></i> : <i class="fi fi-br-angle-small-right relative top-[2px]"></i>}</span>
                                </div>
                                <div className="border border-[rgb(8,43,61)] rounded-xl px-4 py-3 relative">
                                    <p className='xl:text-sm 2xl:text-base font-semibold'><i class="fi fi-rr-gift-card relative top-[2px] mr-1"></i>HAVE A GIFT CARD ?</p>

...
let breadcrum = ["My Account", "Dashboard", "Track Orders"];
...
function TrackOrders() {
    ...
    useEffect(() => {
        let filteredOrders = orders.filter((item) => (item.orderStatus === "Order Placed" || item.orderStatus === "Order Approved" || item.orderStatus === "Pickup Done" || item.orderStatus === "In Transit" || item.orderStatus === "Out for Delivery" && item.isHidden === false));

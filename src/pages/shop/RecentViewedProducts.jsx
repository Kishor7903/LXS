                        ...
                        <div className="w-full grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-x-3 gap-y-4 md:gap-x-5 md:gap-y-5 lg:gap-x-6 lg:gap-y-6 xl:gap-x-4 xl:gap-y-4 p-1">
                            {
                                product.map((item) => {
                                    return (
                                        <div className="w-[100%] rounded-3xl overflow-hidden p-[6px] md:p-2 2xl:p-3 cursor-pointer duration-200 border-slate-300 border-[1px] bg-white relative lg:hover:shadow-md lg:hover:scale-[1.02]">

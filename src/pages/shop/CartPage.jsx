                ...
                <div className="flex lg:min-h-[80vh] flex-col gap-5 rounded-3xl relative py-5 px-4 lg:p-8 shadow-[0px_0px_10px_-2px_rgb(8,43,61)]">
                    <CheckoutNavigator />
                    {
                        cart && cart.length > 0 ? (
                                ...
                                <div className="w-full lg:w-[40%]">
                                    ...
                                    </div>
                                    {
                                        selectedItems.length > 0 && (
                                            <button className="w-full h-10 rounded-full bg-gradient-to-r from-[rgb(248,181,44)] to-[rgb(240,85,120)] text-lg font-semibold text-white my-2 lg:mt-6 lg:hover:shadow-[0px_0px_10px_-3px_rgb(8,43,61)]" onClick={() => navigate("/checkout/address")}>Proceed To Buy</button>
                                        )
                                    }
                            ...
                            (
                                <div className="text-xl opacity-70 flex justify-center items-center h-[40vh] flex-col font-semibold"><i class="fi fi-sr-shopping-cart-add text-[50px]"></i><span className="mt-2">Cart is Empty...</span><span className="text-xs">Oops! No items have landed in your cart yet.</span>

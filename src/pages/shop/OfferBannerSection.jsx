...
function OfferBannerSection() {
    ...
    return (
        <div className="w-full h-[600px] flex flex-col items-center md:flex-row gap-2 md:gap-7 lg:gap-10 px-16 my-10">
            <div onClick={() => navigate("/blank")} className="h-full rounded-xl lg:rounded-2xl overflow-hidden border border-[rgb(8,43,61,0.2)] cursor-pointer hover:scale-[1.01] duration-200 hover:shadow-[0px_0px_20px_-1px_rgb(8,43,61)] lg:hover:border-none shadow-md">

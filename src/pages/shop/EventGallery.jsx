...
function EventGallery() {
    ...
    return (
        <div className="lg:pt-5 space-y-2 lg:space-y-5 w-full h-auto pb-10 border-y">

            <div className="flex flex-col xl:flex-row gap-3 xl:items-center">
                <h3 className={`bg-gradient-to-r from-[rgb(248,181,42)] to-[rgb(240,84,120)] flex items-center rounded-r-full text-lg xl:text-3xl font-semibold pl-5 md:pl-8 lg:pl-12 xl:pl-16 py-1 text-white shadow-[0_5px_5px_-2px_rgb(8,43,61,0.6)] w-40 xl:w-72`}>Mission Logs!</h3>

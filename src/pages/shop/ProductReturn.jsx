...
function ProductReturn() {
    ...
    return (
        <>
            ...
            <div className="w-full h-[95%] pl-4 mt-4 flex gap-10">
                <div className="w-7/12">
                    <div className="leading-[1] font-semibold">Return & Refund Request <br />
                        <p className="text-xs font-normal">Not Satisfied with your purchase? Request a return and refund hassle-free!</p>
                    </div>
                    <div className="rounded-3xl shadow-[0px_0px_10px_-1px_rgb(8,43,61)] border h-[89.5%] mt-5 px-8 py-5 flex flex-col overflow-y-scroll no-scrollbar w-full">
                        ...
                        <div className="w-full flex gap-5">
                            <div className="relative bottom-3 text-xs w-1/2">
                                <p className="text-sm font-semibold">Select Reason for Return & Refund Request</p>
                                <p className="text-orange-500"><span className="relative top-1 text-base">*</span> Reason For Return & Refund </p>
                                ...
                                <p className="text-orange-500"><span className="relative top-1 text-base">*</span> Select Refund Method</p>
                            ...
                            <div className="w-1/2 relative bottom-3 flex flex-col justify-center items-center">
                                ...
                                <button className="text-sm bg-gradient-to-r from-orange-500 to-red-500 px-5 mt-5 py-2 font-semibold rounded-full text-white" onClick={() => setShowReturnAndRefundPopup(true)}>Request Return & Refund</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <RequestSuccessfullPopup showSuccessfullPopup={showReturnAndRefundPopup} setShowSuccessfullPopup={setShowReturnAndRefundPopup} state="Return" />
        </>
    )
}

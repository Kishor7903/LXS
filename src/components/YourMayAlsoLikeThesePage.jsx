...
function YourMayAlsoLikeThesePage({ data, category=false }) {
  ...
  return (
    <div className={`py-5 space-y-2 lg:space-y-5 lg:px-12 xl:px-14 border-t flex-col items-center ${similarProducts?.length > 0 ? "flex" : "hidden"}`}>
      <h2 className='text-xl md:text-3xl font-bold relative after:h-1 after:absolute after:w-2/3 after:left-10 after:-bottom-0 after:bg-[rgb(8,43,61)] after:rounded-full'>Similar Products!</h2>

...
function HomePageLayout() {
    ...
    return (
        <>
            ...
            <div className="flex flex-wrap gap-10 px-16 pt-10">
                {
                    carouselImg.map((img, idx) => 
                    <div onClick={() => navigate(img.url)} key={idx} className="w-[calc(50%-20px)] rounded-xl h-full lg:rounded-2xl overflow-hidden border border-[rgb(8,43,61,0.2)] cursor-pointer lg:hover:scale-[1.02] duration-200 hover:shadow-[0px_0px_20px_-1px_rgb(8,43,61)] lg:hover:border-none shadow-md">
